...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "andrey-bublik-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/vencom"
  #   chef.validation_client_name = "vencom-validator"
  #   chef.validation_key_path = ".chef/vencom-validator.pem"
  # end
end
